...
namespace Microsoft.MixedReality.SceneUnderstanding.Samples.Unity
{
    ...
    public class SceneUnderstandingManager : MonoBehaviour
    {
        ...
        //! When enabled, the scene will be queried from a device (e.g Hololens). Otherwise, a previously saved, serialized scene will be loaded and served from your PC.
        public bool QuerySceneFromDevice = true;
        [Tooltip("The scene to load when not running on the device (e.g Gait lab in Serialized Scenes Folder).")]
        //! The scene to load when not running on the device (e.g Gait lab in Serialized Scenes Folder).
        ...
        //! GameObject that will be the parent of all Scene Understanding related game objects. If field is left empty an empty gameobject named 'Root' will be created.
        ...
        //! Level Of Detail for the scene objects.
        ...
        //! "When enabled, requests observed and inferred regions for scene objects. When disabled, requests only the observed regions for scene objects.
        public bool RequestInferredRegions = true;

        [Header("Render Colors")]
        [Tooltip("Colors for the Scene Understanding Background objects")]
        //! Colors for the Scene Understanding Background objects
        ...
        //! Colors for the Scene Understanding Wall objects
        ...
        //! Colors for the Scene Understanding Floor objects
        ...
        //! Colors for the Scene Understanding Ceiling objects
        ...
        //! Colors for the Scene Understanding Platform objects
        ...
        //! Colors for the Scene Understanding Unknown objects
        ...
        //! Material for Scene Understanding Background in Quad Mode
        ...
        //! Material for scene objects when in Ghost mode (invisible object with occlusion)
        ...
        //! Toggles the display of wall scene objects.
        ...
        //! Toggles the creation of platform objects with collider components
        ...
        //! Toggles the creation of background objects with collider components
        ...
        //! Toggles the creation of unknown objects with collider components
        ...
        //! Toggles the creation of the world mesh with collider components
        ...
        //! Toggles the creation of completely inferred objects with collider components
        ...
        //! Toggles the creation of wall objects with collider components
        public bool AddCollidersInWallSceneObjects = false;

        [Tooltip("Toggles the creation of floor objects with collider components")]
        //! Toggles the creation of floor objects with collider components
        ...
        //! User function that get called when a Scene Understanding event happens
