...
public class SetNoise : MonoBehaviour
{
    ...
    public enum NoiseTypes{ DefaultNoise = 0, PinkNoise = 1, WhiteNoise = 2 };

    /// This will hold the user's selected pattern.
    private NoiseTypes m_PatternType = NoiseTypes.DefaultNoise;
    ...
    private void SetPatternLable()
    {
        ...
        {
            case NoiseTypes.DefaultNoise:
                m_NoiseLable.text = "Noise: Default";
                break;
